<template>
<div class="w-64">
  <div class="bg-slate-300 h-full flex flex-col grow gap-y-5 overflow-y-auto bg-slate-600 px-6 pb-4">
            ...
            <li v-for="link in links">
              <NuxtLink :to="'/'+link.path">
                <a href="#"
                  ...
                  :class="{ 'bg-slate-700 text-white' : route.name.startsWith(link.path), 'text-slate-200 hover:text-white hover:bg-slate-700' : !route.name.startsWith(link.path) }"
                >
