          ...
          <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white p-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div class="sm:flex sm:items-start">
                <div class="">
                  <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Add Goal</DialogTitle>
                  <div class="mt-4 space-y-4">
                    ...
                    <div class="flex space-x-4">
                      <label class="text-sm font-medium leading-6 text-gray-900 flex items-center w-24 ">Goal</label>
                      <div class="w-60">
                        <select v-model="spawnData.goal" class="py-1.5 px-2 flex w-full rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-great-blue-600 sm:max-w-md outline-none">
                          <option v-for="p in players" :value="p.id">{{ p.name }}</option>
                        </select>
                      </div>
                    </div>
                    <div class="flex space-x-4">
                      <label class="text-sm font-medium leading-6 text-gray-900 flex items-center w-24 ">Assist 1</label>
                      <div class="w-60">
                        <select v-model="spawnData.assist1" class="py-1.5 px-2 flex w-full rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-great-blue-600 sm:max-w-md outline-none">
                          <option v-for="p in players" :value="p.id">{{ p.name }}</option>
                        </select>
                      </div>
                    </div>
                    <div class="flex space-x-4">
                      <label class="text-sm font-medium leading-6 text-gray-900 flex items-center w-24 ">Assist 2</label>
                      <div class="w-60">
                        <select v-model="spawnData.assist2" class="py-1.5 px-2 flex w-full rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-great-blue-600 sm:max-w-md outline-none">
                          <option v-for="p in players" :value="p.id">{{ p.name }}</option>
                        </select>
                      </div>
                    </div>
