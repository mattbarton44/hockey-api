<template>
  <div class="w-full">
    <div class="mb-4 font-semibold flex justify-between">
      ...
      <div>
        <button class="text-xs bg-green-400 px-2 py-1 rounded-sm hover:bg-green-600 hover:text-white" @click="navigateTo(`/competitions/new`)">
          Create Competition
        </button>
      </div>
    </div>
...
const nav = (id) => navigateTo('/competitions/'+id)
